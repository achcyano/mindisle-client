...
10. `GET /doctors/me/patients/{patientUserId}/scale-history?limit=20&cursor=<sessionId>`
...
11. `GET /doctors/me/patients/{patientUserId}/scales/sessions/{sessionId}/result`
